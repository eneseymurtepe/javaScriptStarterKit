...
export default class UserService {
  ...
  checkCustomerValidityForErrors(user) {
    ...
    if (Number.isNaN(Number.parseInt(+user.age))) {
      // Kullanıcının yaşını, sayıya çevirmek istediğimde; bu bir sayı değilse, o zaman hata ver.
      hasErrors = true;
      this.errors.push(
  ...
  getCustomersSorted() {
    return this.customers.sort((customer1, customer2) => {
      if (customer1.firstName > customer2.firstName) { // Alfabede hangisinin baş harfi önce geliyorsa.
        return 1;
